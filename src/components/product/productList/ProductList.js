...
import { TbFileCv,TbFileInfo } from "react-icons/tb";
    ...
    <div className='product-list'>
      ...
      <div className='table'>
        ...
        <button className='dataButton'>
            <CSVLink data={products} filename='StudentData' >Export Student Data</CSVLink>
        </button>
        <div className='table'>
                            ...
                            return (
                                <tr key={_id}>
                                    ...
                                    <td className='icons'>
                                        <span>
                                            <Link to={`/cv/${_id}`}>
                                                <TbFileCv size={25} color={"purple"} />
                                            </Link>
                                        </span>
                                        <span>
                                            <Link to={`/client-detail/${_id}`}>
                                                <TbFileInfo size={25} color={"blue"} />
                                            </Link>
                                        </span>
                                        <span>
